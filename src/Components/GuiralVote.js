			...
			<div className="guiral_home">
				<div className="programme_pt1">
					<div className="left_pt">
						<img src={Profile} />
						<h1>
							Des idées<br /> d’aujourd’hui<br /> naissent<br /> les projets<br /> de demain.
						</h1>
					</div>
					<div className="right_pt">
						...
						<div className="programme">
							<h2>LE PROGRAMME</h2>
							<p>
								Vous pensez que c’est l’avenir du marché ? Nous vous mettrons à disposition{' '}
								<b>des intervenants</b> pour discuter de vos projets d’avenir.
							</p>
							<p>
								{' '}
								Comment financer ces projets ? Nous permettrons d’avoir accès à <b>
									des fonds communs
								</b>{' '}
								qui vous aiderons tout au long de vos projets.
							</p>
							<p>
								{' '}
								Devenir entrepreneur est quelque chose qui vous parle ? Mais vous avez peur de vous
								lancer ? Nous mettons en place <b>une équipe d'entrepreneurs pour vous aider</b>.
							</p>
							<p>
								{' '}
								Pour vous amis entrepreneurs, nous vous mettrons en relation avec les meilleurs. Mais
								qui sont les meilleurs me direz vous ? Nous allons créer{' '}
								<b>un groupe Facebook et Linkedin</b> sur lequel des professionnels proposeront
								directement des missions.
							</p>
							<p>
								{' '}
								Marre de vous demandez « on mange où ce midi » ?{' '}
								<b>une restauration dans votre ville</b>.
							</p>
							<p>
								{' '}
								Nous agrandirons votre <b>terrasse</b> avec un plus <b>grand jardin</b> pour pouvoir
								profiter au mieux de vos temps libre.
							</p>
							<p>
								{' '}
								Nous aménagerons une <b>salle</b> qui sera dédiée au <b>sport</b>.
							</p>
							<p>
								{' '}
								Vous voulez <b>des bonbons</b> ? Il y aura bien plus que ça !
							</p>
							<p> … et plus encore.</p>
							<img src={Sup2020} />
						</div>
				...
				<div className="programme_pt2">
					...
					<div className="pt2_right">
						<h1>
							Sa motivation,<br />sa persévérance<br /> et son caractère<br /> de conquérant.
						</h1>
					</div>
				</div>
				<div className="chronology">
					...
					<img className="arrow_month" src={arrow5} />
					<img className="arrow" src={arrow4} />
				</div>
				<div className="actuality">
					<div>
						<Map
							...
							zoom={18}
						>
							<Marker onClick={this.onMarkerClick} name={'Current location'} position={pos} />
						</Map>
					</div>
					<div className="feed">
						...
						<div className="article">
							...
							<div className="article_content">
								...
								<p>
									Lancement de la campagne éléctorale pour les municipales de SUP’Internet 2020.
									Demandez votre documentation pour comprendre notre programme.
								</p>
							</div>
						</div>
						<div className="article">
