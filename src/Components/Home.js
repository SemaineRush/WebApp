    ...
    render() {
        return (
            <div className="home">
                ...
                <div className="candidates">
                    <div className="candidat">
                        ...
                        <div className="candidat_info">
                            ...
                            <span>As promised, here's a relaxing Breath of the Wild songs mix with a calm night ambience in the background. Note that I manually edited some of the songs to keep only the relaxing bits. I think you guys are gonna love this one!</span>
                        </div>
                    </div>
                ...
                <div className="top_left_yellow"></div>
                <div className="bottom_left_pink"></div>
                <div className="bottom_right_purple"></div>
                <div className="bottom_right_blue"></div>
